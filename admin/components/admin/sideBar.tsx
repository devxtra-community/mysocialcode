  ...
  return (
    <aside className="w-[240px] bg-white border-r border-gray-200 fixed top-0 left-0 bottom-0 flex flex-col z-50 shadow-sm">
      ...
      <nav className="flex-1 px-3 py-4 flex flex-col gap-1">
        <p className="text-[9px] tracking-[2px] text-gray-400 uppercase px-3 pb-2">Main Menu</p>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        <div className="flex items-center gap-3 px-3 py-[10px] bg-gray-50 border border-gray-200 rounded-xl">
          ...
          <div className="min-w-0">
            <p className="text-[12px] font-medium text-gray-900 truncate">Super Admin</p>
            <p className="text-[10px] text-gray-400 truncate">admin@eventos.com</p>
          </div>
        </div>
      </div>
